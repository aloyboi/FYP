...
//         _Order memory buyOrderToFill;
//         _Order memory sellOrder;
//         for (uint256 i = 0; i < _sellOrder.length; i++) {
//             //Retrieve buy order to be filled
//             (buyOrderToFill, ) = getOrderFromArray(_tokenA, _tokenB, 0, _id);
...
//                 );
//                 require(
//                     wallet.balanceOf(_tokenA, sellOrder.user) >= saleTokenAmt,
...
//                     _tokenA,
//                     _tokenB,
//                     _fillOrderValues(sellOrder.rate, saleTokenAmt)
//                 );
//                 fillOrder(
//                     Side.SELL,
//                     sellOrder.id,
...
//             bool orderExist = orderExists(_id, Side.BUY, _tokenA, _tokenB);
//             if (!orderExist) break;
//         }
//     }
